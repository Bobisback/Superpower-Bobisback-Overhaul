...
function RefreshCityBanner(cityBanner, iActiveTeam, iActivePlayer)
	...
	--------------------------------------------SP City Show City Focus END--------------------------
		...
		if city:GetPopulation() > 0 and cityOwner:IsHuman()
		and controls.CityIcon_TOWN ~= nil 
		and controls.CityIcon_SMALL ~= nil 
		and controls.CityIcon_MEDIUM ~= nil 
		and controls.CityIcon_LARGE ~= nil 
		and controls.CityIcon_XL ~= nil 
		and controls.CityIcon_XXL ~= nil 
		and controls.CityIcon_GLOBAL ~= nil then
		...
		if cityOwner:IsHuman() 
		and controls.CityIcon_Lv1 ~= nil 
		and controls.CityIcon_Lv2 ~= nil 
		and controls.CityIcon_Lv3 ~= nil
	    and controls.CityIcon_Lv4 ~= nil
		and controls.CityIcon_Lv5 ~= nil 
		and controls.CityIcon_NOAC ~= nil then
...
function GarrisonComplete( cityBanner, pCity )
	...
	local controls = cityBanner.SubControls;
	if active_team == team and controls.GarrisonFrame ~= nil then
